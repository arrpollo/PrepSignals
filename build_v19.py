...
@media(max-width:760px){
  ...
  .logo{font-size:15px}
  .nav{gap:3px}
  .nav button{font-size:11.5px;padding:6px 7px}
...
<header class="bar"><div class="wrap">
  ...
  <nav class="nav">
    <button id="nav-plan" class="on" onclick="showView('plan')"><span class="navfull">Your plan</span><span class="navshort">Plan</span></button>
